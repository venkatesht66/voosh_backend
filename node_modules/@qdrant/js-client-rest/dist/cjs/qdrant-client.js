...
class QdrantClient {
    constructor({ url, host, apiKey, https, prefix, port = 6333, timeout = 300000, checkCompatibility = true, ...args } = {}) {
        ...
        const headers = new Headers([['user-agent', 'qdrant-js/' + String(client_version_js_1.PACKAGE_VERSION)]]);
        ...
        if (checkCompatibility) {
            this._openApiClient
                ...
                if (!client_version_js_1.ClientVersion.isCompatible(client_version_js_1.PACKAGE_VERSION, serverVersion)) {
                    console.warn(`Client version ${client_version_js_1.PACKAGE_VERSION} is incompatible with server version ${serverVersion}. Major versions should match and minor version difference must not exceed 1. Set checkCompatibility=false to skip version check.`);
                }
            })
                .catch(() => {
