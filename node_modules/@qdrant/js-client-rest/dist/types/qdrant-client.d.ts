import { SchemaFor, Schemas } from './types.js';
...
export declare class QdrantClient {
     ...
     */
    collectionClusterInfo(collection_name: string): Promise<Schemas['CollectionClusterInfo']>;
    /**
     ...
     * @returns Operation result
     */
    updateCollectionCluster(collection_name: string, { timeout, ...operation }: {
        timeout?: number;
    } & SchemaFor<'ClusterOperations'>): Promise<boolean>;
    /**
     * Update vectors
     * @param collection_name
     * @param {object} args
    ...
    } & SchemaFor<'UpdateVectors'>): Promise<Schemas['UpdateResult']>;
    /**
     * Delete vectors
     * @param collection_name
     * @param {object} args
    ...
    deleteVectors(collection_name: string, { wait, ordering, points, filter, vector, shard_key, }: {
        wait?: boolean;
        ordering?: SchemaFor<'WriteOrdering'>;
    } & SchemaFor<'DeleteVectors'>): Promise<Schemas['UpdateResult']>;
    /**
     * Search point groups
     * @param collection_name
     * @param {object} args -
    ...
    searchPointGroups(collection_name: string, { consistency, timeout, shard_key, vector, filter, params, with_payload, with_vector, score_threshold, group_by, group_size, limit, }: {
        ...
        timeout?: number;
    } & SchemaFor<'SearchGroupsRequest'>): Promise<Schemas['GroupsResult']>;
    /**
    ...
    recommendPointGroups(collection_name: string, { consistency, timeout, shard_key, positive, strategy, negative, filter, params, with_payload, with_vector, score_threshold, using, lookup_from, group_by, group_size, limit, }: {
        ...
        timeout?: number;
    } & SchemaFor<'RecommendGroupsRequest'>): Promise<Schemas['GroupsResult']>;
    /**
    ...
    upsert(collection_name: string, { wait, ordering, ...points_or_batch }: {
        wait?: boolean;
        ordering?: SchemaFor<'WriteOrdering'>;
    } & SchemaFor<'PointInsertOperations'>): Promise<Schemas['UpdateResult']>;
    /**
    ...
    delete(collection_name: string, { wait, ordering, ...points_selector }: {
        wait?: boolean;
        ordering?: SchemaFor<'WriteOrdering'>;
    } & SchemaFor<'PointsSelector'>): Promise<Schemas['UpdateResult']>;
    /**
    ...
    setPayload(collection_name: string, { payload, points, filter, shard_key, key, ordering, wait, }: {
        wait?: boolean;
        ordering?: SchemaFor<'WriteOrdering'>;
    } & SchemaFor<'SetPayload'>): Promise<Schemas['UpdateResult']>;
    /**
    ...
    deletePayload(collection_name: string, { ordering, keys, points, filter, shard_key, wait, }: {
        wait?: boolean;
        ordering?: SchemaFor<'WriteOrdering'>;
    } & SchemaFor<'PointsSelector'> & SchemaFor<'DeletePayload'>): Promise<Schemas['UpdateResult']>;
    /**
     ...
     */
    getCollectionAliases(collection_name: string): Promise<Schemas['CollectionsAliasesResponse']>;
    /**
     * Get all aliases
     * @returns All aliases of all collections
     */
    getAliases(): Promise<Schemas['CollectionsAliasesResponse']>;
    /**
     ...
     */
    getCollection(collection_name: string): Promise<Schemas['CollectionInfo']>;
    /**
     ...
     *         If timeout is reached, request will return with service error.
     */
    createCollection(collection_name: string, { timeout, vectors, hnsw_config, on_disk_payload, optimizers_config, quantization_config, replication_factor, shard_number, sharding_method, wal_config, write_consistency_factor, sparse_vectors, strict_mode_config, }: {
        timeout?: number;
     ...
     *         If timeout is reached, request will return with service error.
     */
    recreateCollection(collection_name: string, { timeout, vectors, hnsw_config, on_disk_payload, optimizers_config, quantization_config, replication_factor, shard_number, sharding_method, wal_config, write_consistency_factor, sparse_vectors, strict_mode_config, }: {
        timeout?: number;
    } & SchemaFor<'CreateCollection'>): Promise<boolean>;
    /**
    ...
    createPayloadIndex(collection_name: string, { wait, ordering, field_name, field_schema, }: {
        wait?: boolean;
        ordering?: SchemaFor<'WriteOrdering'>;
    } & SchemaFor<'CreateFieldIndex'>): Promise<Schemas['UpdateResult']>;
    /**
     ...
     */
    listSnapshots(collection_name: string): Promise<Schemas['SnapshotDescription'][]>;
    /**
     ...
     * @returns List of snapshots
     */
    listFullSnapshots(): Promise<Schemas['SnapshotDescription'][]>;
    /**
    ...
    batchUpdate(collection_name: string, { wait, ordering, ...operations }: {
        wait?: boolean;
        ordering?: SchemaFor<'WriteOrdering'>;
    } & SchemaFor<'UpdateOperations'>): Promise<Schemas['UpdateResult'][]>;
    /**
     ...
     * @returns Operation result
     */
    listShardSnapshots(collection_name: string, shard_id: number): Promise<Schemas['SnapshotDescription'][]>;
    /**
    ...
    discoverPoints(collection_name: string, { consistency, timeout, shard_key, target, context, params, limit, offset, with_payload, with_vector, using, lookup_from, }: {
        ...
        timeout?: number;
    } & SchemaFor<'DiscoverRequest'>): Promise<Schemas['ScoredPoint'][]>;
    /**
    ...
    discoverBatchPoints(collection_name: string, { consistency, timeout, searches, }: {
        ...
        timeout?: number;
    } & SchemaFor<'DiscoverRequestBatch'>): Promise<Schemas['ScoredPoint'][][]>;
    /**
     ...
     * @returns Operation result
     */
    versionInfo(): Promise<Schemas['VersionInfo']>;
    /**
    ...
    query(collection_name: string, { consistency, timeout, shard_key, prefetch, query, using, filter, params, score_threshold, limit, offset, with_vector, with_payload, lookup_from, }: {
        ...
        timeout?: number;
    } & SchemaFor<'QueryRequest'>): Promise<Schemas['QueryResponse']>;
    /**
    ...
    queryBatch(collection_name: string, { consistency, timeout, searches, }: {
        ...
        timeout?: number;
    } & SchemaFor<'QueryRequestBatch'>): Promise<Schemas['QueryResponse'][]>;
    /**
    ...
    queryGroups(collection_name: string, { consistency, timeout, shard_key, prefetch, query, using, filter, params, score_threshold, with_vector, with_payload, group_by, group_size, limit, with_lookup, }: {
        ...
        timeout?: number;
    } & SchemaFor<'QueryGroupsRequest'>): Promise<Schemas['GroupsResult']>;
    /**
    ...
    facet(collection_name: string, { consistency, timeout, shard_key, key, limit, filter, exact, }: {
        ...
        timeout?: number;
    } & SchemaFor<'FacetRequest'>): Promise<Schemas['FacetResponse']>;
    /**
    ...
    searchMatrixPairs(collection_name: string, { consistency, timeout, shard_key, filter, sample, limit, using, }: {
        ...
        timeout?: number;
    } & SchemaFor<'SearchMatrixRequest'>): Promise<Schemas['SearchMatrixPairsResponse']>;
    /**
    ...
    searchMatrixOffsets(collection_name: string, { consistency, timeout, shard_key, filter, sample, limit, using, }: {
        ...
        timeout?: number;
    } & SchemaFor<'SearchMatrixRequest'>): Promise<Schemas['SearchMatrixOffsetsResponse']>;
}
